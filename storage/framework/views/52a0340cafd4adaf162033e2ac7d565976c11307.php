<div class="dc-settingscontent dc-tabsinfo la-profilephoto">
    <?php if(!empty($avatar)): ?>
        ...
        :existing_img_url="'<?php echo e(url('uploads/users/'.$id.'/'.$avatar.'')); ?>'"
        :size = "'<?php echo e(Helper::getImageDetail( $avatar, 'size', 'uploads/users/'.$id)); ?>'"
        :existing_img_name = "'<?php echo e(Helper::getImageDetail( $avatar, 'name', 'uploads/users/'.$id)); ?>'"
        >
        </upload-media>
    <?php else: ?>
...
<div class="dc-settingscontent dc-tabsinfo">
    <?php if(!empty($banner)): ?>
        ...
        :existing_img_url="'<?php echo e(url('uploads/users/'.$id.'/'.$banner.'')); ?>'"
        :size = "'<?php echo e(Helper::getImageDetail( $banner, 'size', 'uploads/users/' .$id)); ?>'"
        :existing_img_name = "'<?php echo e(Helper::getImageDetail( $banner, 'name', 'uploads/users/' .$id)); ?>'"
        >
        </upload-media>
    <?php else: ?>
    <div class = "dc-formtheme dc-userform">
...
<?php /**PATH E:\xamp\htdocs\doctry\resources\views/back-end/admin/users/edit/media.blade.php ENDPATH**/ ?>